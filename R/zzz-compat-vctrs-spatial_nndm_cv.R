...
#' @export
vec_restore.spatial_nndm_cv <- function(x, to, ...) {
...
#' @export
vec_ptype2.spatial_nndm_cv.spatial_nndm_cv <- function(x, y, ..., x_arg = "", y_arg = "") {
  stop_never_called("vec_ptype2.spatial_nndm_cv.spatial_nndm_cv")
}
#' @export
vec_ptype2.spatial_nndm_cv.tbl_df <- function(x, y, ..., x_arg = "", y_arg = "") {
  stop_never_called("vec_ptype2.spatial_nndm_cv.tbl_df")
}
#' @export
vec_ptype2.tbl_df.spatial_nndm_cv <- function(x, y, ..., x_arg = "", y_arg = "") {
  stop_never_called("vec_ptype2.tbl_df.spatial_nndm_cv")
}
#' @export
vec_ptype2.spatial_nndm_cv.data.frame <- function(x, y, ..., x_arg = "", y_arg = "") {
  stop_never_called("vec_ptype2.spatial_nndm_cv.data.frame")
}
#' @export
vec_ptype2.data.frame.spatial_nndm_cv <- function(x, y, ..., x_arg = "", y_arg = "") {
  stop_never_called("vec_ptype2.data.frame.spatial_nndm_cv")
}
...
#' @export
vec_cast.spatial_nndm_cv.spatial_nndm_cv <- function(x, to, ..., x_arg = "", to_arg = "") {
  stop_incompatible_cast_rset(x, to, x_arg = x_arg, to_arg = to_arg)
}
#' @export
vec_cast.spatial_nndm_cv.tbl_df <- function(x, to, ..., x_arg = "", to_arg = "") {
  stop_incompatible_cast_rset(x, to, x_arg = x_arg, to_arg = to_arg)
}
#' @export
vec_cast.tbl_df.spatial_nndm_cv <- function(x, to, ..., x_arg = "", to_arg = "") {
  tib_cast(x, to, ..., x_arg = x_arg, to_arg = to_arg)
}
#' @export
vec_cast.spatial_nndm_cv.data.frame <- function(x, to, ..., x_arg = "", to_arg = "") {
  stop_incompatible_cast_rset(x, to, x_arg = x_arg, to_arg = to_arg)
}
#' @export
vec_cast.data.frame.spatial_nndm_cv <- function(x, to, ..., x_arg = "", to_arg = "") {
