...
#' @export
vec_ptype2.spatial_leave_location_out_cv.spatial_leave_location_out_cv <- function(
  x,
  y,
  ...,
  x_arg = "",
...
#' @export
vec_ptype2.spatial_leave_location_out_cv.tbl_df <- function(
  x,
  y,
  ...,
  x_arg = "",
...
#' @export
vec_ptype2.tbl_df.spatial_leave_location_out_cv <- function(
  x,
  y,
  ...,
  x_arg = "",
...
#' @export
vec_ptype2.spatial_leave_location_out_cv.data.frame <- function(
  x,
  y,
  ...,
  x_arg = "",
...
#' @export
vec_ptype2.data.frame.spatial_leave_location_out_cv <- function(
  x,
  y,
  ...,
  x_arg = "",
...
#' @export
vec_cast.spatial_leave_location_out_cv.spatial_leave_location_out_cv <- function(
  x,
  to,
  ...,
  x_arg = "",
...
#' @export
vec_cast.spatial_leave_location_out_cv.tbl_df <- function(
  x,
  to,
  ...,
  x_arg = "",
...
#' @export
vec_cast.tbl_df.spatial_leave_location_out_cv <- function(
  x,
  to,
  ...,
  x_arg = "",
...
#' @export
vec_cast.spatial_leave_location_out_cv.data.frame <- function(
  x,
  to,
  ...,
  x_arg = "",
...
#' @export
vec_cast.data.frame.spatial_leave_location_out_cv <- function(
  x,
  to,
  ...,
  x_arg = "",
