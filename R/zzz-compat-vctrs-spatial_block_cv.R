...
#' @export
vec_ptype2.spatial_block_cv.spatial_block_cv <- function(
  x,
  y,
  ...,
  x_arg = "",
...
#' @export
vec_ptype2.spatial_block_cv.tbl_df <- function(
  x,
  y,
  ...,
  x_arg = "",
...
#' @export
vec_ptype2.tbl_df.spatial_block_cv <- function(
  x,
  y,
  ...,
  x_arg = "",
...
#' @export
vec_ptype2.spatial_block_cv.data.frame <- function(
  x,
  y,
  ...,
  x_arg = "",
...
#' @export
vec_ptype2.data.frame.spatial_block_cv <- function(
  x,
  y,
  ...,
  x_arg = "",
...
#' @export
vec_cast.spatial_block_cv.spatial_block_cv <- function(
  x,
  to,
  ...,
  x_arg = "",
...
#' @export
vec_cast.spatial_block_cv.tbl_df <- function(
  x,
  to,
  ...,
  x_arg = "",
...
#' @export
vec_cast.tbl_df.spatial_block_cv <- function(
  x,
  to,
  ...,
  x_arg = "",
...
#' @export
vec_cast.spatial_block_cv.data.frame <- function(
  x,
  to,
  ...,
  x_arg = "",
...
#' @export
vec_cast.data.frame.spatial_block_cv <- function(
  x,
  to,
  ...,
  x_arg = "",
