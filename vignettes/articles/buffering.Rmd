...
```{r 2022-06-23_boston-block-gif, animation.hook="gifski"}
...
```{r 2022-06-23_boston-block-buffer-gif, animation.hook="gifski"}
purrr::walk(blocks$splits, function(x) {
  p <- autoplot(x)
  ggplot2::ggsave("png_test.png", p)
  print(p)
})
```
...
```{r 2022-06-23_boston-block-buffer-m-gif, animation.hook="gifski"}
set.seed(123)
...
```{r 2022-06-23_boston-block-buffer-eps-gif, animation.hook="gifski"}
set.seed(123)
blocks <- spatial_block_cv(
  boston_canopy, 
  v = 5, 
...
```{r 2022-06-23_boston-block-radius-eps-gif, animation.hook="gifski"}
set.seed(123)
blocks <- spatial_block_cv(
  boston_canopy, 
  v = 5, 
...
```{r 2022-06-23_boston-block-disc-visible, eval = FALSE}
set.seed(123)
...
```{r 2022-06-23_boston-block-disc-executed, echo = FALSE, animation.hook="gifski"}
set.seed(123)
blocks <- spatial_buffer_vfold_cv(
  boston_canopy, 
  v = nrow(boston_canopy), 
